...
pset = {'coeff_a':(-.318,.15,'norm'), ##Effect of Media Reliance
        'coeff_b':(.250,.12,'norm'), ##Intercept: Media Impact
        'coeff_c':(.043,.02,'norm'), ##Intercept: Social Impact
        'coeff_d':(1.51,.25,'normp'), ##Ratio of Spatial vs. Ideological distance
        'coeff_e':(-.003,.002,'norm')} ## Effect of Attitude certainty
