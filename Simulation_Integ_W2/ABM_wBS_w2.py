...
pset = {'coeff_a':(0,.01,'norm'), ##Effect of Media Reliance
        ...
        'coeff_d':(1.0,.05,'normp'), ##Ratio of Spatial vs. Ideological distance
...
outfile1 = "SimResult_Crossval_full.txt"        ## Complete collection of simulation results for each parameter set
outfile2 = "SimResult_Crossval.txt"             ## Summary per generation, providing M, SD and 95% CI for each parameter
summary_file = 'Summary_Crossval.txt'           ## Summary after maximal number of generations, including cross-validation with test data
